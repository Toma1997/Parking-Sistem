<div>
    ...
    <div class="font-weight-light content clearfix">
       <div class="float-left mt-4"> 
    	<p>Možete nam poslati e-mail i popunjavanjem formulara koji sledi:</p>
		<form method="post">
			...
			<div class="form-group-sm">
					<img id="captcha" class="col-sm-10 img-fluid" src="securimage/securimage_show.php" alt="CAPTCHA Image" />
					<input type="text" id="captcha_code" name="code" class="form-control input-sm" size="10" placeholder="Unesite kod sa slike" maxlength="6" required />			
			</div>
